...
const calendarReducer = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        // case calendarActionTypes.ADD_EVENTS_TO_STATE:
        //     return {
        //         ...state,
        //         eventData: calendarUtils.addEventsToState(state.dateClickedOpenEvent, state.eventData, action.payload)
        //     }

        // case calendarActionTypes.DELETE_EVENTS_FROM_STATE:
        //     return {
        //         ...state,
        //         eventData: calendarUtils.deleteEventsFromState(action.payload, state.eventData, state.dateClickedOpenEvent)
        //     }

        // case calendarActionTypes.EDIT_EVENTS_FROM_STATE:
        //     return {
        //         ...state,
        //         eventData: calendarUtils.editEventsFromState(state.eventData, state.dateClickedOpenEvent, action.payload)
        //     }
